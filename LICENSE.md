...
Pure Blog is free to use, modify, and self-host.
...
1. Use Pure Blog to run your own website, blog, or community platform — whether personal or commercial.
2. Modify the code for your own use.
3. Share modified versions, as long as this license stays with it.

Pure Blog is provided as-is with no warranty whatsoever.