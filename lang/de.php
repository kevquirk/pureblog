...
return [
    ...
    'admin' => [
        ...
        'login' => [
            ...
            'mfa_page_title' => 'Zwei-Faktor-Authentifizierung – Pure Blog',
            'mfa_heading'    => 'Zwei-Faktor-Authentifizierung',
            'mfa_prompt'     => 'Gib den 6-stelligen Verifizierungscode aus deiner Authentifikator-App oder einen Wiederherstellungscode ein.',
            'mfa_code_label' => 'Verifizierungs- oder Wiederherstellungscode',
            'mfa_submit'     => 'Bestätigen',
            'mfa_cancel'     => 'Zurück zur Anmeldung',
            'mfa_error_invalid' => 'Ungültiger Verifizierungs- oder Wiederherstellungscode.',
        ],
        ...
        'settings' => [
            ...
            'site' => [
                ...
                'tip_og_image'           => 'Empfohlen: 1.360 × 712 px für Banner oder 1.200 × 1.200 px für quadratisch',
            ...
            'user' => [
                ...
                'mfa_section_title'             => 'Zwei-Faktor-Authentifizierung',
                'mfa_status_enabled'            => 'Aktiv',
                'mfa_enabled_desc'              => 'Zwei-Faktor-Authentifizierung ist für dein Konto aktiviert.',
                'mfa_disabled_desc'             => 'Schütze dein Konto zusätzlich, indem du bei der Anmeldung einen 6-stelligen Code aus einer Authentifikator-App anforderst.',
                'mfa_setup_btn'                 => 'Zwei-Faktor-Authentifizierung einrichten',
                'mfa_setup_instructions'        => 'Scanne den QR-Code mit deiner Authentifikator-App (z. B. 1Password, Google Authenticator, Bitwarden oder Aegis) und gib den 6-stelligen Verifizierungscode unten ein.',
                'mfa_manual_entry_intro'        => 'Oder gib diesen geheimen Schlüssel manuell in deine App ein:',
                'mfa_enter_code_label'          => 'Verifizierungscode',
                'mfa_activate_btn'              => 'Überprüfen und aktivieren',
                'mfa_cancel_btn'                => 'Einrichtung abbrechen',
                'mfa_notice_enabled'            => 'Zwei-Faktor-Authentifizierung wurde erfolgreich aktiviert.',
                'mfa_notice_disabled'           => 'Zwei-Faktor-Authentifizierung wurde deaktiviert.',
                'mfa_notice_codes_regenerated'  => 'Neue Wiederherstellungscodes wurden generiert.',
                'mfa_error_verify_code'         => 'Ungültiger Verifizierungscode. Bitte überprüfe deine Authentifikator-App und versuche es erneut.',
                'mfa_error_password'            => 'Falsches Passwort.',
                'mfa_backup_codes_heading'      => 'Wichtig: Speichere deine Wiederherstellungscodes',
                'mfa_backup_codes_warning'      => 'Bewahre diese Codes an einem sicheren Ort auf. Falls du den Zugriff auf deine Authentifikator-App verlierst, kann jeder Code einmalig zur Anmeldung verwendet werden.',
                'mfa_regenerate_codes_title'    => 'Neue Wiederherstellungscodes generieren',
                'mfa_regenerate_codes_btn'      => 'Neue Codes generieren',
                'mfa_disable_title'             => 'Zwei-Faktor-Authentifizierung deaktivieren',
                'mfa_disable_btn'               => '2FA deaktivieren',
                'mfa_confirm_password_label'    => 'Bestätige dein aktuelles Passwort',
                'mfa_copy'                      => 'Kopieren',
